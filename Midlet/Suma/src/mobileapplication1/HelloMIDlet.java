...
exitMIDlet();//GEN-LINE:|7-commandAction|2|19-postAction
                ...
                int num1 = Integer.parseInt(textField.getString());
                int num2 = Integer.parseInt(textField1.getString());
//GEN-LINE:|7-commandAction|4|25-postAction
                stringItem.setText(String.valueOf(num1 + num2));
...
//GEN-END:|14-getter|0|14-preInit
            // write pre-init user code here
form = new Form("Welcome", new Item[]{getTextField(), getTextField1(), getStringItem()});//GEN-BEGIN:|14-getter|1|14-postInit
...
//GEN-END:|24-getter|0|24-preInit
 // write pre-init user code here
okCommand = new Command("Calcular", Command.OK, 0);//GEN-LINE:|24-getter|1|24-postInit
 // write post-init user code here
...
//GEN-END:|27-getter|0|27-preInit
 // write pre-init user code here
textField = new TextField("Numero A:", "", 32, TextField.ANY);//GEN-LINE:|27-getter|1|27-postInit
 // write post-init user code here
...
//<editor-fold defaultstate="collapsed" desc=" Generated Getter: textField1 ">//GEN-BEGIN:|28-getter|0|28-preInit
    /**
...
//GEN-END:|28-getter|0|28-preInit
 // write pre-init user code here
textField1 = new TextField("Numero B:", "", 32, TextField.ANY);//GEN-LINE:|28-getter|1|28-postInit
 // write post-init user code here
...
//GEN-END:|29-getter|0|29-preInit
 // write pre-init user code here
stringItem = new StringItem("Resultado:", "");//GEN-LINE:|29-getter|1|29-postInit
 // write post-init user code here
