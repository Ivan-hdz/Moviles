...
//GEN-LINE:|7-commandAction|4|24-postAction
                ...
                testMaravilloso(Integer.parseInt(textField.getString()));
                stringItem.setText(result.toString());
...
//GEN-END:|14-getter|0|14-preInit
            // write pre-init user code here
form = new Form("N\u00FAmero maravilloso", new Item[]{getTextField(), getStringItem()});//GEN-BEGIN:|14-getter|1|14-postInit
...
//<editor-fold defaultstate="collapsed" desc=" Generated Getter: okCommand ">//GEN-BEGIN:|23-getter|0|23-preInit
 ...
 // write pre-init user code here
okCommand = new Command("Probar", Command.OK, 0);//GEN-LINE:|23-getter|1|23-postInit
 // write post-init user code here
...
//<editor-fold defaultstate="collapsed" desc=" Generated Getter: textField ">//GEN-BEGIN:|22-getter|0|22-preInit
 ...
 // write pre-init user code here
textField = new TextField("Numero a probar", "", 32, TextField.ANY);//GEN-LINE:|22-getter|1|22-postInit
 // write post-init user code here
...
//<editor-fold defaultstate="collapsed" desc=" Generated Getter: stringItem ">//GEN-BEGIN:|25-getter|0|25-preInit
 ...
 // write pre-init user code here
stringItem = new StringItem("Resultado", "");//GEN-LINE:|25-getter|1|25-postInit
 // write post-init user code here
...
//</editor-fold>//GEN-END:|25-getter|2|
    ...
    private void testMaravilloso(int maravilloso) {
        if(maravilloso == 1) {
            result.append("1");
        }else {
            if(maravilloso%2 == 0) {
                result.append(String.valueOf(maravilloso) + " -> " + String.valueOf(maravilloso) + " / 2 ===> " + String.valueOf(maravilloso/2) + "\n");
                testMaravilloso(maravilloso/2);
            } else {
                result.append(String.valueOf(maravilloso) + " ->" + String.valueOf(maravilloso) + " x 3 + 1 ===> " + String.valueOf(maravilloso*3 + 1) + "\n");
                testMaravilloso(maravilloso*3 + 1);
            }
        }
    }
